...
trait PostgresGrammarTypes
{
    ...
    /**
     * Create the column definition for storing an array date type.
     *
     * TODO: add info
     *
     * @param  \Illuminate\Support\Fluent  $column
     * @return string
     */
    protected function typeArr(Fluent $column)
    {
        return 'array';
    }

    /**
     * Create the hstore column data type
     *
     * TODO: add info
     *
     * @param  \Illuminate\Support\Fluent  $column
